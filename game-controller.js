...
class GameController {
    ...
    showFinalScoring() {
        ...
        if (sixthBox4) sixthBox4.textContent = touristScore;

        // Populate final-box-1, 2, 3 with the calculated score for hubs (2pts, 5pts, 9pts)
        const finalBox1 = document.getElementById('final-box-1');
        const finalBox2 = document.getElementById('final-box-2');
        const finalBox3 = document.getElementById('final-box-3');
        const finalBox4 = document.getElementById('final-box-4');
